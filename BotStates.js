...
var sendFBmessage = require('./messanger/sendFBmessage'),
  skillQuestions = require('./botQuestions/skillQuestions'),
  answerVariants = require('./db/modelDB').answerVariants,
  generalQuestion = require('./botQuestions/generalBotQuestion'),
  specQuestion = require('./botQuestions/specializationQuestion'),
  timer = require('./components/Timer'),
  find = require('./messanger/find'),
  additionalQuestion = require('./botQuestions/additionalBotQuestions');
